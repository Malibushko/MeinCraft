...
///
class GLPBOTextureSurface : public UltraLightGLTextureSurface
{
public:
...
UltraLightGLTextureSurfaceFactory::UltraLightGLTextureSurfaceFactory()
{
}
...
ultralight::Surface * UltraLightGLTextureSurfaceFactory::CreateSurface(uint32_t width, uint32_t height)
{
  ///
...
void UltraLightGLTextureSurfaceFactory::DestroySurface(ultralight::Surface * surface)
{
  ///
